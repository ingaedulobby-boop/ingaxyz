...
export default function AIHealthHero() {
  ...
  return (
    <div
      ref={ref}
      className="relative h-[50vh] min-h-[400px] overflow-hidden bg-gradient-to-b from-slate-900 to-slate-950 flex flex-col items-center justify-center px-[12px]"
      ...
      <motion.div
        className="relative z-10 w-full max-w-lg backdrop-blur-xl bg-white/5 border border-white/10 p-6 sm:p-8 shadow-[0_0_80px_rgba(34,211,238,0.15)] hero-parallax-layer rounded-sm py-[10px] px-[10px]"
