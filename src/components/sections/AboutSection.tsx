...
function SkillCard({ icon: Icon, label, desc, index }: {icon: typeof Brain;label: string;desc: string;index: number;}) {
  ...
  return (
    <motion.div
      ...
      className="p-3 sm:p-4 bg-card/60 border border-border hover:border-primary/30 hover:shadow-[0_4px_20px_-4px_hsl(var(--primary)/0.1)] transition-all duration-300 will-change-transform rounded-sm">
